...
from simulation import simulate_ces_2in, mu_ces
...
def main():
    ...
    all_results = []
    ces_params_true = dict(CES_PARAMS_TRUE)
    ...
    for i, seed in enumerate(SEEDS, start=1):
        ...
        log_frontier_true = mu_ces(ces_params_true, logx1_obs, logx2_obs)
        ...
        with open(os.path.join(run_dir, "true_params.json"), "w") as f:
            json.dump(
                {
                    "N": N, "seed": seed,
                    "ces_params_true": ces_params_true,
